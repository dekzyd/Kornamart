  ...
  return (
    <>
      <div className="flex flex-wrap gap-2 sm:gap-x-6 items-center justify-center">
        <h1 className="text-2xl font-bold leading-none tracking-tight sm:text-6xl ">
          We love
        </h1>
        <div className="stats bg-primary shadow">
          <div className="stat">
            <div className="stat-title text-primary-content text-4xl lg:text-4xl font-bold tracking-widest">
              KornaMart
            </div>
          </div>
        </div>
      ...
      <p className="mt-6 text-2xl font-bold leading-8 max-w-4xl mx-auto">
        What set's us apart?
      </p>
      <ul className="mt-2 text-md leading-8 max-w-4xl mx-auto">
        <li>
      ...
      <div className="mt-2 text-md leading-8 max-w-4xl mx-auto">
        <li>Home & Living</li>
      ...
      <p className="mt-6 text-2xl font-bold leading-8 max-w-4xl mx-auto mb-2.5">
        Get in Touch
      </p>
